...
def get_friends_listening_now(user_id: str) -> list[dict]:
    ...
    # Only include events from today (UTC calendar day), not a rolling 24h window,
    # so a friend's listen from yesterday evening drops off once the date turns over.
